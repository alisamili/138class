...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 3, width: 500, height: 300, top: -40, left: -130, $opacity: 0.3 },
            { '&zIndex': 4, width: 900, height: 390, top: -90, left: 50, $opacity: 1 },
            { '&zIndex': 3, width: 500, height: 300, top: -40, left: 630, $opacity: 0.3 }
        ]
